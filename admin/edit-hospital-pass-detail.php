...
$eid=$_GET['editid'];
$sql="update tblhospitalpass set FullName=:fname,ContactNumber=:cnum,Email=:email,IdentityType=:itype,IdentityCardno=:icnum,HospitalName=:cat,Reason=:reason,FromDate=:fdate,ToDate=:tdate where ID=:eid";
...
<head>
    ...
    <title>Curfew Pass Management System | Edit Hospital Pass</title>
        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Hospital Pass</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <?php
$eid=$_GET['editid'];
$sql="SELECT * from  tblhospitalpass where ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?> 
	...
	<table border="1" class="table" > 
                                    <tr align="center">
									<td colspan="2" style="font-size:20px;color:Red">Hospital Visit Pass</td>
<td colspan="3" style="font-size:20px;color:blue">
 Pass ID: <?php  echo ($row->PassNumber);?></td></tr> </table>
...
<option value="Any Other Govt Issued Doc">Any Other Govt Issued Doc</option>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Identity Card No.</label> <input type="text" name="icnum" value="<?php  echo $row->IdentityCardno;?>" class="form-control" required='true'> </div>
     <div class="form-group"> <label for="exampleInputEmail1">Hospital Name</label><select type="text" name="category" value="" class="form-control" required='true'>
      <option value="<?php  echo $row->HospitalName;?>"><?php  echo $row->HospitalName;?></option>
<?php 

$sql2 = "SELECT * from   tblhospital";
...
{          
    ?>  
<option value="<?php echo htmlentities($row2->HospitalName);?>"><?php echo htmlentities($row2->HospitalName);?></option>
 <?php } ?>
     </select></div>
<div class="form-group"> <label for="exampleInputEmail1">Reason To visit Hospital</label> <input type="text" name="reason" value="<?php  echo $row->Reason;?>" class="form-control" required='true'> </div>
