...
$eid=$_GET['editid'];
$sql="update tblemployeepass set FullName=:fname,ContactNumber=:cnum,Email=:email,IdentityType=:itype,IdentityCardno=:icnum,CompanyName=:cat,Designation=:reason,FromDate=:fdate,ToDate=:tdate where ID=:eid";
...
<head>
    ...
    <title>Curfew Pass Management System | Edit Employee Pass</title>
        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Employee Movement Pass</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <?php
$eid=$_GET['editid'];
$sql="SELECT * from  tblemployeepass where ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?> 
	...
	<table border="1" class="table" > 
                                    <tr align="center">
									<td colspan="2" style="font-size:20px;color:Red">Employee Movement Pass</td>
...
<option value="Any Other Govt Issued Doc">Any Other Govt Issued Doc</option>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Company Name</label> <input type="text" name="category" value="<?php  echo $row->CompanyName;?>" class="form-control" required='true'> </div>
     
<div class="form-group"> <label for="exampleInputEmail1">Designation</label> <input type="text" name="reason" value="<?php  echo $row->Designation;?>" class="form-control" required='true'> </div>
