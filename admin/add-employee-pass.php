...
$sql="insert into tblemployeepass(PassNumber,FullName,ContactNumber,Email,IdentityType,IdentityCardno,CompanyName,Designation,FromDate,ToDate)values(:passnum,:fname,:cnum,:email,:itype,:icnum,:cat,:reason,:fdate,:tdate)";
...
echo "<script>window.location.href ='add-employee-pass.php'</script>";
  }
  else
    {
...
<head>
    ...
    <title>Curfew Pass Management System | Add Employee Pass</title>
        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Generate Employee Movement Pass</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
...
<option value="Any Other Govt Issued Doc">Any Other Govt Issued Doc</option>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Company Name</label> <input type="text" name="category" value="" class="form-control" required='true'> </div>
    <div class="form-group"> <label for="exampleInputEmail1">Designation</label> <input type="text" name="reason" value="" class="form-control" required='true'> </div>
