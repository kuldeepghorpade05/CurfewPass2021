                        ...
                        <div class="panel-body">
                            <div class="row" id="divToPrint">
                                <div class="col-lg-12">
                                   <?php
$vid=$_GET['viewid'];
$sql="SELECT * from  tblmarriagepass where ID=$vid";
...
<table border="1" class="table table-bordered" > 
 ...
 <tr>
  ...
  <tr>
    <th scope>From Location</th>
    <td><?php  echo ($row->FromLocation);?></td>
    <th scope>To Location</th>
...
<tr>
  ...
  <tr>
    <th scope>Bride side / Groom Side</th>
    <td><strong><?php  echo ($row->Side);?></strong></td>
