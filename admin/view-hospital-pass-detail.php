                        ...
                        <div class="panel-body">
                            <div class="row" id="divToPrint">
                                <div class="col-lg-12">
                                   <?php
$vid=$_GET['viewid'];
$sql="SELECT * from  tblhospitalpass where ID=$vid";
...
<td colspan="3" style="font-size:20px;color:blue">
 Pass ID: <?php  echo ($row->PassNumber);?></td></tr>
  ...
  <tr>
    ...
    <td colspan="3"><strong><?php  echo ($row->FullName);?></strong></td>
  </tr>
...
<tr>
   ...
   <tr>
    ...
    <td colspan="3"><?php  echo ($row->HospitalName);?></td>
  </tr>
   <tr>
        <th scope>Reason To Visit Hospital</th>
